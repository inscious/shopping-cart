...
const Navbar = () => {
    return (
        <header id="navbar" className="bg-[#1A1B25] w-screen h-16 fixed">
            <div
                id="navbar-container"
                className="mx-auto flex max-w-7xl w-full items-center h-full bg-slate-00 duration-150 justify-between px-3 xl:px-0"
            >
                {/* Redux Logo */}
                <>
                    <svg
